...
<head>
  ...
  <title>Tables / General - RGUKT Bootstrap Template</title>
        ...
        <div class="col-lg-6">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <p>Use contextual classes <code>.table-primary .table-secondary .table-success .table-danger
                  .table-warning .table-info .table-light .table-dark</code> to color tables, table rows or individual
                cells.</p>
              <!-- Table Variants -->
              <table class="table">
                <thead>
        ...
        <div class="col-lg-6">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <p><a href="https://getbootstrap.com/docs/5.0/utilities/borders/#border-color" target="_blank">Border
                  color utilities</a> can be added to change colors:</p>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <p>Add <code>.table-sm</code> to make any <code>.table</code> more compact by cutting all cell padding in
                half.</p>
              <!-- Small tables -->
